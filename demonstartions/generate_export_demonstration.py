...
def runner(env, model_path, timesteps_per_batch, number_trajs,
    ...
    while current_traj_num <= number_trajs:
        ...
        if returns < 1224.0 - 200 or returns > 1224.0 + 200:
    ...
    if save:
        ...
        file_name = '/sac_{}_model_{}_mean_{}.npz'.format(args.env_name, suffix,
...
if __name__ == '__main__':
    ...
    suffix = '1272'  # add additional information, default= ''
